...
public class BandNameGenerator {
	...
	public String generateName() {
		...
		if (adjectivesLoaded && nounsLoaded) {
			// Get the total number of adjectives and nouns from their respective string lists.
	...
	public static void main(String[] args) {
		...
		BandNameGenerator newBandName = new BandNameGenerator("../../../../adjectives.txt",
				"../../../../nouns.txt"); // Create a BandNameGenerator instance with file paths.
